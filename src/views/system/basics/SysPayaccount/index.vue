...
<!--            </a-col>-->
      ...
      <div class="table-operations">
        ...
        <a-button type="primary" :disabled="single" @click="$refs.createForm.handleUpdate(undefined, ids)" v-hasPermi="['system:SysPayaccount:edit']">
          <a-icon type="edit" />修改
        </a-button>
...
<script>
import { listSysPayaccount, delSysPayaccount, exportSysPayaccount } from '@/api/system/SysPayaccount'
